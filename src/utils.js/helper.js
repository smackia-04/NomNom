...
export const Cart_Logo = ({ length }) => {
    return (
      <div className=" relative ">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="28" color="#000000" fill="none">
          <path
          ...
          {length > 0 && (
            <text x="8" y="18" fontSize="11" fontWeight="bold" fill="black">
              {length}
            </text>
          )}
        </svg>
