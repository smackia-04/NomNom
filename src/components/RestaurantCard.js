...
const RestCard = ({name, cloudinaryImageId, avgRatingString, cuisines,sla }) => {
    return (
        <div className=" w-[250px] h-[330px] rounded-xl bg-gray-50 hover:bg-gray-50 p-2 m-3 hover:shadow-lg ">
            <img className="h-[225px] rounded-xl w-full pb-1" src={IMG_CDN_LINK + cloudinaryImageId} alt="card-image"></img>
