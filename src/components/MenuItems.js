...
import { MENU_ITEM_CDN_URL } from "../utils.js/constants";
                    ...
                    {itemAttribute && (
                        <span className="flex items-center gap-x-3">
                            {itemAttribute.vegClassifier === "NONVEG" ? (
                                <FontAwesomeIcon
                                    className="border border-solid border-[#e43b4f] text-[#e43b4f] max-h-4 max-w-4 p-0.5 text-xs -rotate-90 rounded-sm"
                                    icon={faPlay}
                                />
                            ) : (
                                <FontAwesomeIcon
                                    icon={faCircle}
                                    className="border border-solid border-[#0f8a65] text-[#0f8a65] max-h-4 max-w-4 p-0.5 text-xs rounded-sm"
                                />
                            )}
